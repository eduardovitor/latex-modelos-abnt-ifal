...
\input{elementos-textuais/objetivos.tex}    % Objetivos
\input{elementos-textuais/justificativa.tex}  % Justificativa
\input{elementos-textuais/referencialteorico} % Referencial teórico
\input{elementos-textuais/metodologia.tex}    % Metolodogia
\input{elementos-textuais/recursos.tex}       % Recursos
\input{elementos-textuais/cronograma}         % Cronograma
